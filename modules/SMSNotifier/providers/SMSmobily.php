...
class SMSNotifier_SMSmobily_Provider implements SMSNotifier_ISMSProvider_Model {

	private $_username;
	private $_password;
	private $_parameters = array();

	const SERVICE_URI = 'http://www.smsmobily.com/';

	private static $REQUIRED_PARAMETERS = array('sender','unicode','return');
	...
	public function getServiceURL($type = false) {
		if ($type) {
			switch (strtoupper($type)) {
				case self::SERVICE_AUTH : return self::SERVICE_URI . 'api/sendsms.php';
				case self::SERVICE_SEND : return self::SERVICE_URI . 'api/sendsms.php';
				case self::SERVICE_QUERY : return self::SERVICE_URI . 'api/sendsms.php';
			}
		}
		return false;
	}
	...
	public function send($message, $tonumbers) {
		...
		$params['numbers'] = implode(',', $tonumbers);
