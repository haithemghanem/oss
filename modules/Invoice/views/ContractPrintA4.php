...
class Invoice_ContractPrintA4_View extends Vtiger_View_Controller {
...
<html>
					  ...
					  if($adb->num_rows($result9) > 0)
					    {
						  ...
						  while($roww9 = $adb->fetch_array($result9))
							           	...
							           	<td  style="padding: 2px 0px 1px 0px;">
							           		<div style="height: 90px;width: 100%;border:0px solid #000;">
							                	...
							                	<div style="width: 35%; float: right;">
							                		<p align="center"   style="margin: 1px 1px; " class="" >رقم الفاتـــــورة</p>
							                		<p align="center"   style="margin: 1px 1px; "  class="">رقم عقد الشحن</p>
							                		<p align="center"   style="margin: 1px 1px;"  class="" >تاريخ الشـــحن</p>
							                	</div>
						   ...
						   echo '<tr>
                			<td>'.$ns.'</td>
                			<td>'.$decr.'</td>
                			<td >'.number_format($roww9['quantity'],2).'</</td>
                			<td >'.number_format($roww9['listprice'],2).'</</td>
                			<td >'.number_format($roww9['margin'],2).'</</td>
                		</tr>';
				                  	...
				                  	<tbody>
				                  		<tr>
				                  			<td  width="35%" style="border: 1px solid #858796">
				                  				...
				                  				<h2>غايتنا/السرعة.المصداقية.السعر المناسب</h2>
 ...
 يجب مراجعة المكتب وعمل عقد خاص بذلك</h3>
				            ...
				            <tr>
				                  ...
				                  <td  style="border:0px solid #000000; border-top: 0px; padding-top: 10px;">
				            		    <strong style="width: 23%; float: right;">الموظف:</strong>
				            			<div style=" float: right;"> 
				            				
				            				<p style="text-align: right;margin: 0px; font-weight: bold;"><?php echo $invoice_assigned_to;?>  </p>
				            			</div>
				            		</td>
				            	   ...
				            	   <td  colspan="2" style="border:0px solid #000000; border-top: 0px; padding-top: 10px;">
				            		    ...
				            		    <strong style="float: right;"> تأمين سيارات خاصة وكمبليت/جدة:</strong>
				            			<div style="float: right;"> 
				            		...
				            		<td  style="border:0px solid #000000; border-top: 0px; padding-top: 10px;">
				            			<strong style="float: right;"> للملاحظة والاستفسار:</strong>
				            			<div style=" float: right;"> 
				            				<p style="text-align: right;margin: 0px; font-weight: bold;"><?php echo $orgphone ; ?> </p>
				            			</div>
				            		</td>
