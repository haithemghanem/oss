...
class Invoice_CarriersReportPrint3_View extends Vtiger_View_Controller {
          ...
          if($adb->num_rows($result) > 0)
            {
              ...
              while($roww = $adb->fetch_array($result))
               { 
                ...
                $coustreqird = ((($coust - $seroffice)/2)+$tax)-$Invoice_Received;   //$Invoice_Balance - $seroffice;
...
<html>
    <head>
        ...
        <title>تقرير سيارات الرياض </title>
