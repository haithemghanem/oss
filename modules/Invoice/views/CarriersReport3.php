...
class Invoice_CarriersReport3_View extends Vtiger_Index_View {
	 ...
	 <div class="main" style="min-height: 600px;">
	   ...
	   jQuery(document).ready(function() { 
		  ...
		  jQuery("#formrepor").submit(function(e){
		  	...
		  	var urlex="?module=Invoice&view=CarriersReportPrint3&carriersid="+carriersid+"&frombranch="+frombranch+"&tobranch="+tobranch+"&date="+dateid+"&condate="+condate
		  	+"&dateto="+dateidto+"&sender="+idsender+"&recipient="+idrecipient;
