...
class Invoice_ContractsReport_View extends Vtiger_Index_View {
	   ...
	   jQuery(document).ready(function() { 
		 ...
		 jQuery("#datecondion").on('change',function(e ){
		  ...
		  jQuery("#formrepor").submit(function(e){
		  	...
		  	var urlex="?module=Invoice&view=ContractsReportPrint&frombranch="+frombranch+"&Carriersid="+carriersid+"&tobranch="+tobranch+"&date="+dateid+"&dateto="+dateto+"&datecondion="+datecondion+"&capnum="+capnum;
