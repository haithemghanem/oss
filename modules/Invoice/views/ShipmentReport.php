...
//ShipmentReportPrint
class Invoice_ShipmentReport_View extends Vtiger_Index_View {
	 ...
	 <div class="main" style="min-height: 600px;">
            ...
            <br>
             ...
             <div class="col-sm-10 floaclass" style="">
	            ...
	            <div class="col-sm-2 floaclass" style="">
	            	...
	            	<button onclick="exportToExcel()"  class="btn btn-default" type="button" id="bton-excel"><strong>اكسل</strong></button>
	   ...
	   jQuery(document).ready(function() { 
		  ...
		  jQuery("#formrepor").submit(function(e){
		  	...
		  	var urlex="?module=Invoice&view=ShipmentReportPrint&frombranch="+frombranch+"&carriersid="+carriersid+"&tobranch="+tobranch+"&date="+dateid+"&condate="+condate
		  	+"&dateto="+dateidto+"&sender="+idsender+"&recipient="+idrecipient+"&capnum="+capnum+"&excl="+excl;
