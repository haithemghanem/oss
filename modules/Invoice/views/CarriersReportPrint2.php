...
class Invoice_CarriersReportPrint2_View extends Vtiger_View_Controller {
          ...
          if($adb->num_rows($result) > 0)
            {
              ...
              while($roww = $adb->fetch_array($result))
               { 
                ...
                $coustreqird = $Invoice_Balance - $seroffice;
                $coustreqird_totoal +=$coustreqird;
                ...
                $data.='<tr class="padding-1">
                 ...
                 <td>'.number_format($coustreqird,2).'</td>
               ...
               $data.='<tr class="padding-1">
                 ...
                 <td colspan="2"><input type="text" style="max-width: 60px;"> </td>
                 ...
                 <td class="wrwarp">'.number_format($coustreqird_totoal,2).'</td>
                 </tr>
...
<html>
    <head>
        ...
        <title><?php  echo $Carriersid; ?>-<?php  echo vtranslate($frombranch,'Invoice'); ?>-<?php  echo $tobranchlebel ?></title>
