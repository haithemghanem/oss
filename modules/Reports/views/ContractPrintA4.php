...
class Reports_ContractPrintA4_View extends Vtiger_View_Controller {
							           	...
							           	<td  colspan="2" style="padding: 2px 0px 1px 0px;">
							           		<div style="height: 90px;width: 100%;border:0px solid #000;">
							                	<div style="">
							                		...
							                		<p align="center"  style="margin: 1px 1px;"  class="" > <b>الرقم الضرببي:</b> 12345678912345</p>
							                	</div>
							           		</div>
							           	</td>
                                        ...
                                        <tr> 
							            	...
							            	<td   colspan="2"  style="padding: 2px 0px 1px 0px;">
							                	...
							                	<div style="width: 70%; float: left; ">
							                	    ...
							                	    <p align="center" class="invoceinfohead" ><?php echo vtranslate($from_broch); ?> </p>
							            	...
							            	<td colspan="2"  style="padding: 2px 0px 1px 0px;">
							                	...
							                	<div style="width: 70%; float: left; ">
							                		...
							                		<p align="center" class="invoceinfohead" style=""><?php echo vtranslate($invoice_to_branch); ?> </p>
