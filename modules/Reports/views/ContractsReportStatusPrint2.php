...
class Reports_ContractsReportStatusPrint2_View extends Vtiger_View_Controller {
    ...
    function process(Vtiger_request $request) {
       ...
       (( vtiger_invoicecf.cf_948 = '$frombranch' AND  vtiger_invoicecf.cf_991 ='$status'  and  vtiger_invoice.invoicedate = '$date' and vtiger_invoicecf.cf_954 =$carrid  AND  vtiger_invoicecf.cf_950 ='$tobranch' AND vtiger_invoicecf.cf_958='$capnum' ) ) GROUP BY vtiger_invoice.invoice_no order by vtiger_invoice.invoice_no   LIMIT 0, 5000 
        ";
          ...
          if($adb->num_rows($result) > 0)
            {
              ...
              while($roww = $adb->fetch_array($result))
               ...
               <td colspan="5">الاجمالي الكلي</td>
                ...
                $data= '<tr style="text-align: center;"><td colspan="5">لايوجد سجلات لعرضها</td></tr> ';
            }
