...
class Reports_MandoubReport_View extends Vtiger_Index_View {
	 ...
	 <div class="main" style="min-height: 600px;">
	       ...
	       <div class="col-md-12">
	        <div class="col-sm-4 floaclass" style="">
	                ...
	                <div class="col-sm-9 aligntestclass">
	                  <select  id="mandubid" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" name="" data-selected-value="" tabindex="-1" title="" required>
				             <option value="">حدد مندوب</option>
				             
				             <?php
				     
                              $sql ="SELECT vtiger_mandub.mandubid, vtiger_mandub.name FROM vtiger_mandub 
				             ...
				             if($adb->num_rows($result) >= 1)
				              {
					            while($roww = $adb->fetch_array($result))
					             { 
					               ...
					               echo '<option value="'.$roww['mandubid'].'" >'.$roww['name'].'</option>';
					             }
				              }
	   ...
	   jQuery(document).ready(function() { 
		  ...
		  jQuery("#formrepor").submit(function(e){
		  	...
		  	var mandubid = jQuery("#mandubid").val();
		  	...
		  	var urlex="?module=Reports&view=MandoubReportPrint&mandubid="+mandubid+"&frombranch="+frombranch+"&date="+dateid+"&condate="+condate
		  	+"&dateto="+dateidto;
