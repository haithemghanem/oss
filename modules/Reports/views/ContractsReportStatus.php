<?php
//ContractsReportStatus

class Reports_ContractsReportStatus_View extends Vtiger_Index_View {
	...
	function process (Vtiger_request $request) {
           ...
           <div class="row">
            ...
            <div class="col-sm-3 floaclass" style="">
             ...
             <div class="col-sm-4 floaclass"> 
               ...
               <div class="col-sm-4 floaclass"> 
	                <div class="col-sm-5  floaclass aligntestclass ">
	                   <?php  echo vtranslate('Delivery Status','Invoice');?>
	                </div>
	                <div class="col-sm-7 aligntestclass">

	                	 <select  id="status"  class="inputElement" type="picklist" name=""  title="" >
	                	 	 <option value="Not Received"><?php  echo vtranslate('Not Received','Invoice');?> </option>
				             <option value="Received"><?php  echo vtranslate('Received','Invoice');?> </option>
				             <option value="Create"><?php  echo vtranslate('Create','Invoice');?> </option>
				             <option value="Rejected"><?php  echo vtranslate('Rejected','Invoice');?> </option>
     ...
     jQuery(document).ready(function() {
      ...
      jQuery("#formrepor").submit(function(e){
        ...
        var urlex="?module=Reports&view=ContractsReportStatusPrint&status="+status+"&frombranch="+frombranch+"&tobranch="+tobranch+"&date="+dateid+"&condate="+condate
        +"&dateto="+dateidto;
