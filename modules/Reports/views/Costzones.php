...
class Reports_Costzones_View extends Vtiger_Index_View {
    ...
    <div class="main" style="min-height: 600px;">
     ...
     jQuery(document).ready(function() {
      ...
      jQuery("#formrepor").submit(function(e){
        ...
        //var host = window.location.hostname; CostzonesPrint
        
        var urlex="?module=Reports&view=CostzonesPrint&frombranch="+frombranch+"&tobranch="+tobranch+"&date="+dateid+"&condate="+condate+"&carri="+carriersid;
        +"&dateto="+dateidto;
