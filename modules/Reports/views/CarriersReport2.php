...
class Reports_CarriersReport2_View extends Vtiger_Index_View {
	 ...
	 <div class="main" style="min-height: 600px;">
	   ...
	   jQuery(document).ready(function() { 
		  ...
		  jQuery("#formrepor").submit(function(e){
		  	...
		  	var urlex="?module=Reports&view=CarriersReportPrint2&carriersid="+carriersid+"&frombranch="+frombranch+"&tobranch="+tobranch+"&date="+dateid+"&condate="+condate
