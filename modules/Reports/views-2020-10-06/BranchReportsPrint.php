               ...
               { 
                ...
                $data.='<tr>
                 ...
                 <td>'.$numcapan.'</td>
                  ...
                  <td><a target="_blank" href="index.php?module=Reports&view=BranchReportsPrint2&tobranch='.$robranch.'&carrid='.$Carriersnid.'&date='.$invoic_Data.'&capnum='.$numcapan.'"> التفاصيل  </a> </td>
