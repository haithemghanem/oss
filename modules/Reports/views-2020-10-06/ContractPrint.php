...
class Reports_ContractPrint_View extends Vtiger_View_Controller {
					  ...
					  if($adb->num_rows($result9) > 0)
					    {
						  ...
						  while($roww9 = $adb->fetch_array($result9))
						   ...
						   echo '<tr>
                			<td>'.$ns.'</td>
                			<td>'.$decr.'</td>
                			<td style="text-align: right;">'.intval($roww9['quantity']).'</</td>
                			<td style="text-align: right;">'.intval($roww9['listprice']).'</</td>
                			<td style="text-align:right;">'.intval($roww9['margin']).'</</td>
                		</tr>';
				                	...
				                	<table width="100%" >
				                  	<tbody>
				                  		<tr>
				                  			...
				                  			<td style="" width="8%">
				                  				<p class="cont-1"><?php echo number_format($storagevalue,2) ;?></p>
				                  				<p class="cont-1"><?php echo number_format($deliveryvalue,2) ;?></p> 
				                  			...
				                  			<td style="" width="26%">
				                  				...
				                  				<p class="cont-2"><?php echo  number_format($othercoust,2); ?></p>
				                  				<p class="cont-2" ><?php echo   number_format($Invoice_Received ,2); ?></p>
