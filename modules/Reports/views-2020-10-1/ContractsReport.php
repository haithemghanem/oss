	   ...
	   jQuery(document).ready(function() { 
		 ...
		 jQuery("#datecondion").on('change',function(e ){
		  ...
		  jQuery("#formrepor").submit(function(e){
		  	...
		  	var urlex="?module=Reports&view=ContractsReportPrint&Carriersid="+carriersid+"&tobranch="+tobranch+"&date="+dateid+"&dateto="+dateto+"&datecondion="+datecondion+"&capnum="+capnum;
