...
class Reports_CompanyReport_View extends Vtiger_Index_View {
	 ...
	 <div class="main" style="min-height: 600px;">
	       ...
	       <div class="col-md-12">
	        <div class="col-sm-4 floaclass" style="">
	                <div class="col-sm-4 aligntestclass floaclass">
	                  <?php  echo vtranslate('Account Name','Vtiger');?>
	                </div>
	                 
	                <div class="col-sm-8 aligntestclass">
	                  <select  id="companyname" data-fieldtype="picklist"   class="inputElement select2  select2-offscreen" type="picklist" name="" data-selected-value=""  tabindex="-1" title="" required>
	                     <option value=""><?php  echo vtranslate('Select Company','Invoice');?></option>
	                    <?php 
	                    $quer="SELECT vtiger_account.accountid,vtiger_account.accountname  FROM vtiger_account
                                INNER JOIN vtiger_crmentity on vtiger_crmentity.crmid = vtiger_account.accountid AND  vtiger_crmentity.deleted=0 ORDER BY  vtiger_crmentity.modifiedtime DESC";
	                       $paramter=array();
				             ...
				             if($adb->num_rows($result) > 0)
				              {
					             ...
					             { 
					                echo '<option value="'.$roww['accountid'].'">'.$roww['accountname'].'</option>';
					              }
				              }
	                    ?>
            ...
            <br>
             ...
             <div class="col-sm-10 floaclass" style="">
	                ...
	                <?php  echo vtranslate('Date Contractr','Invoice');?>
	                </div>
	   ...
	   jQuery(document).ready(function() { 
		  ...
		  jQuery("#formrepor").submit(function(e){
		  	...
		  	var urlex="?module=Reports&view=CompanyReportPrint&companyname="+companyname+"&tobranch="+tobranch+"&date="+dateid+"&condate="+condate
		  	+"&dateto="+dateidto;
