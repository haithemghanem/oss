<?php /* Smarty version Smarty-3.1.19, created on 2019-06-21 04:27:40
         compiled from "C:\wamp\www\yemensys\portal\layouts\default\templates\Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:272115d0c5cbce584c0-50793599%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '21386f352fdd3c804dc74cbd7085f98efae5f29f' => 
    array (
      0 => 'C:\\wamp\\www\\yemensys\\portal\\layouts\\default\\templates\\Header.tpl',
      1 => 1558223428,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '272115d0c5cbce584c0-50793599',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d0c5cbd34c3b6_15282984',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d0c5cbd34c3b6_15282984')) {function content_5d0c5cbd34c3b6_15282984($_smarty_tpl) {?>
...
"></script>
		...
		<?php if (getdefultleng()=='ar_ae') {?>
          <link rel="stylesheet" href="libraries/bootstrap.rtl.css" type="text/css" media="screen" />
	...
	<body ng-controller="MainController" ng-cloak  leng="<?php echo getdefultleng();?>
">
				...
				<div class="col-lg-8 col-md-8 col-sm-6 col-xs-6 portalnavbar" ng-if="loginUser">
					<ul class=" nav navbar-nav headerLinks menu" ng-show="modules">
						<li ng-class="{'active':isActive('Home')}">
							<a translate="Home" href="index.php"> {{'Home'|translate}}</a>
						</li>
