<?php
/*+***********************************************************************************
 * The contents of this file are subject to the vtiger STE-BMC Public License Version 1.1
...
$languageStrings = array(
	...
	'LBL_COMPOSE_EMAIL_WARNING' => ' Warning : Your email might land in spam. Add STE-BMC as an authorized sender for your domain. Learn more',
	// Common Link Labels
	...
	'LBL_CRM_SETTINGS' => 'STE-BMC Settings',
	...
	'LBL_ADD_SERVICE' => 'Add Package Categories',
	'LBL_LI_ADD_PRODUCT' => 'Product',
	'LBL_LI_ADD_SERVICE' => 'Package Categories',
	...
	'LBL_TYPE_AND_SEARCH' => 'Type and Search',
		'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT'=>'For exporting Currency values in Line items, STE-BMC will use this setting to export as this currency. Any currency values outside the line items tables, will be exported as in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'STE-BMC On Demand',
	...
	'COMPANY_LOGO_HELP_TEXT' => 'Please upload your lovely company logo. <br>Besides showing your company logo on your STE-BMC,<br>
	...
	'COMPANY_LOGO_HELP_TEXT_2' =>"You can edit company details later from <br>
									'STE-BMC Settings > Templates > Company Details' page",
	...
	'PREFERENCES_HELP_TEXT' => 'Base Currency - Choose your primary currency. If you use multiple<br> 
								...
								using the conversion rate configured in STE-BMC.',
	'PREFERENCES_HELP_TEXT_2' => 'Personal preferences can be configured by each user in your team.<br>
									...
									number fields in the STE-BMC<br>
	...
	'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring contacts from Google and <br> you can also enable bi-direction sync to keep our<br>
									Solutions Time STE-BMC contacts and Google contacts(in selected group) updated.<br>
	...
	'TELL_US_ABOUT_YOU_HELP_TEXT' => 'We continue to make improvements to the STE-BMC, and <br>
	...
	'LBL_SOCIAL_LINKED' => 'Your STE-BMC is now linked to',
	'LBL_ENTER_KEYWORDS_HELP'=>'STE-BMC will scan twitter and find messages with these words',
	...
	'LBL_DEFAULT_REPLY_TO_INFO' => 'This setting is applicable only for direct emails from STE-BMC. It doesn\'t affect emails sent from workflows, email campaigns, etc.', 
	...
	'LBL_TIME' => 'Time',
	'LBL_SKIPPED' => 'Skipped',
	'vt_create' => 'Records Created in STE-BMC',
	'vt_update' => 'Records Updated in STE-BMC',
	'vt_delete' => 'Records Deleted in STE-BMC',
	'vt_skip' => 'Records skipped in STE-BMC',
	...
	'LBL_INTERNAL_COMMENT_INFO' => 'The comment will only be seen by STE-BMC users, if the internal comment checkbox is enabled. To notify customers (through configurable workflows or customer portal) leave this checkbox disabled',
	'LBL_CHANGE' => 'Change',
	...
	'LBL_SHARED_LIST_NON_ADMIN_MESSAGE' => 'This is a Shared list. Please contact your STE-BMC Administrator to configure columns for All list',
	...
	'LBL_CHAT_WITH_SUPPORT' => 'Live chat with STE-BMC expert',

	'LBL_ROLES' => 'Roles',
	'LBL_ROLEANDSUBORDINATE' => 'Role and Subordinates',
	'LBL_YOUR_LEARNING_SCORE' => 'Your STE-BMC learning score',
	'LBL_SWITCH_TO_VTIGER7_NOW' => 'Switch to STE-BMC7 by Feb 15th',
	...
	'LBL_DUPLICATES_FOUND_MESSAGE' => '%s-%s exists in  %s.',
	'LBL_VTIGER_NOTIFICATION' => 'Message from : STE-BMC System Notifications',
...
$jsLanguageStrings = array(
	...
	'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, STE-BMC will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'JS_INTERNAL_COMMENT_INFO' => 'The comment will only be seen by STE-BMC users, if the internal comment checkbox is enabled. To notify customers (through configurable workflows or customer portal) leave this checkbox disabled',
	...
	'JS_SUITABLE_VTIGER_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Suitable STE-BMC field not available for mapping',
	...
	'JS_MORE_VTIGER' => 'There are more records to be synchronized in STE-BMC',
	...
	'JS_LBL_HELP' => 'Help',
	'JS_LBL_HELP_TEXT' => 'Click on Help button to find Guides and FAQs, and use the Help menu dropdown to get assistance from STE-BMC support team',
