...
class Vtiger_Functions {
	...
	static function initStorageFileDirectory() {
		...
		if (!is_dir($filepath . $year)) {
			//create new folder
			mkdir($filepath . $year);
			mkdir($filepath . $year ,0777,true);
			chmod($filepath . $year, 0755);
		...
		if (!is_dir($filepath . $year . "/" . $month)) {
			...
			mkdir($filepath . $monthFilePath ,0777,true);
			chmod($filepath . $monthFilePath, 0755);
		...
		if (!is_dir($filepath . $year . "/" . $month . "/" . $week)) {
			...
			mkdir($filepath . $weekFilePath ,0777,true);
			chmod($filepath . $weekFilePath, 0755);
