...
<input type="hidden" id="sharedUsersInfo" value= {Zend_Json::encode($SHAREDUSERS_INFO)} />
 <div class="activitytype-indicator calendar-feed-indicator" style="background-color: rgb(249, 13, 35);">
        <span>
		{vtranslate('LBL_ALL',$MODULE)}
	  </span>
	    <span class="activitytype-actions pull-right" id="selectalluser">
					<input class="cursorPointer" id="checkalluser" type="checkbox"  data-calendar-feed="Events">
		</span>
  </div>
