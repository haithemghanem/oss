...
Vtiger.Class("Google_Map_Js", {}, {
  ...
  thisInstance.loadMaplocaScript();
   
  },

  showlocalztion: function(){
  	var letm=document.getElementById('maplet').val();
   var legm=document.getElementById('maplng').val();
   var uluru = {lat:letm , lng: legm};

  // The map, centered at Uaul
  var map = new google.maps.Map(
   document.getElementById('maplocaltion'), {zoom: 4, center: uluru});
  ...
  var marker = new google.maps.Marker({position: uluru, map: map});
	...
	loadMaplocaScript : function() {
    // jQuery.getScript("http://maps.googleapis.com/maps/api/js?key=AIzaSyDN_GUnUwvA6_iW0yyNAhDl64bia2JjBOU&callback=showlocalztion",function () {});
	},

	loadMapScript : function() {
		//	jQuery.getScript("https://maps.google.com/maps/api/js?sensor=true&async=2&callback=initialize", function () {});
		jQuery.getScript("https://maps.googleapis.com/maps/api/js?key=AIzaSyDY44B55qSjwPsLW5lu4TOZY6O0UPQtzaE&callback=initialize", function () {});
