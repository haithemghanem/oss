...
Vtiger_Edit_Js("Contacts_Edit_Js",{},{
	...
	registerBasicfouct : function(form){
	     
	    var element = jQuery('#Contacts_editView_fieldName_firstname', form);
	    element.trigger( "focus" );
	    jQuery('#Contacts_editView_fieldName_firstname').on('focusout',function(e){
	        //jQuery('#Contacts_editView_fieldName_firstname').focus();
	        //console.log("mmmmmmmmmmmm7777777777mmmmmmmmm");
	    });
	...
	registerBasicEvents: function (container) {
		...
		this.registerBasicfouct(container);
	}
})