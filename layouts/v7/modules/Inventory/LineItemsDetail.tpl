...
<div class="details block">
    <div class="lineItemTableDiv  itemprodectde">
        <table class="table table-bordered lineItemsTable" style = "margin-top:15px">
            ...
            <th colspan="{$COL_SPAN2}" class="lineItemBlockHeader ">
                ...
                {vtranslate('LBL_CURRENCY', $MODULE_NAME)} : {vtranslate($CURRENCY_INFO['currency_name'],'vtiger')}({$CURRENCY_INFO['currency_symbol']})
            </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {/if}
                    <td class="lineItemFieldName">
                        <strong class="">{vtranslate('LBL_TOTAL',$MODULE_NAME)}</strong>
                    </td>
                    {if $MARGIN_VIEWABLE}
                        <td class="lineItemFieldName">
                            <strong class="">{vtranslate({$LINEITEM_FIELDS['margin']->get('label')},$MODULE_NAME)}</strong>
                        </td>
                    {/if}
                    <td class="lineItemFieldName">
                        <strong class="">{vtranslate('LBL_NET_PRICE',$MODULE_NAME)}</strong>
                    </td>
                </tr>
                {foreach key=INDEX item=LINE_ITEM_DETAIL from=$RELATED_PRODUCTS}
                    <tr>
                        ...
                        <td>
                            ...
                            {/if}
                            <div align = "right" class="discountleble hide">{$LINE_ITEM_DETAIL["totalAfterDiscount$INDEX"]}</div>
                            {if $FINAL_DETAILS.taxtype neq 'group'}
    ...
    <table class="table table-bordered lineItemsTable">
        <tr>
            ...
            <td>
                <span align="right" class="pull-left">
        ...
        {/if}
         ...
         <tr class="hide">
             <td width="83%">
                 <div align="right">
                     <strong>{vtranslate('Total After Tax',$MODULE)}
                </div>

             </td>
             <td>
                 <div align="right">
                    {$FINAL_DETAILS['tax_totalamount'] + $FINAL_DETAILS["preTaxTotal"] } 
                </div>
            </td>
         </tr>
        ...
        <tr class="hide">
            <td width="83%">
                <div align="right">
                    <strong>{vtranslate('Storage Value',$MODULE_NAME)}</strong>
                </div>
            </td>
            <td>
                <div align="right">
                    {$FINAL_DETAILS["storagevalue"]}
                </div>
            </td>
        </tr>
         <tr class="hide">
            <td width="83%">
                <div align="right">
                    <strong>{vtranslate('Delivery value',$MODULE_NAME)}</strong>
                </div>
            </td>
            <td>
                <div align="right">
                    {$FINAL_DETAILS["deliveryvalue"]}
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div align="right">
                    {* intval(str_replace(',', '', $FINAL_DETAILS["grandTotal"]) ) *}
                     {$FINAL_DETAILS["grandTotal"]}
                    {* number_format(str_replace(',', '', $FINAL_DETAILS["grandTotal"]),2) *}
            ...
            <tr>
                ...
                <td>
                    <div align="right">
                        ...
                        {* intval(str_replace(',', '', $RECORD->getDisplayValue('balance'))) *}
                         {$RECORD->getDisplayValue('balance')}
                        {* number_format(str_replace(',', '', $RECORD->getDisplayValue('balance')),2) *}
                        {else}0
                        {/if}
                    </div>
                </td>
