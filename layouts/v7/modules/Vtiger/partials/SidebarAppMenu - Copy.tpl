...
<div class="app-menu hide" id="app-menu">
	<div class="container-fluid">
		...
		<div class="app-list row">
			...
			<div class="menu-item app-item app-item-misc" data-default-url="index.php?module=WorkDay&amp;view=List&app=SUPPORT">
					<div class="menu-items-wrapper">
					    <span class="module-icon"><i class="fa fa-calendar" title="WorkDay"></i></span>
						<span class="module-name textOverflowEllipsis">{vtranslate('WorkDay')} </span>
					</div>
				</div>
