                ...
                {if count($LISTVIEW_MASSACTIONS_1) gt 0 or $LISTVIEW_LINKS['LISTVIEW']|@count gt 0}
                    <div class="btn-group listViewMassActions" role="group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            {if $MODULE == "Invoice"}
                            <li class="hide"><a id="{$MODULE}_listView_massAction_"  href="javascript:void(0);" onclick='Vtiger_List_Js.triggerSendSms("index.php?module=Invoice&view=MassActionAjax&mode=showMandoubForm","Invoice");'>تعديل المندوب</a></li>
                            <li class="hide"><a id="{$MODULE}_listView_massAction_Staus"  href="javascript:void(0);" onclick='Vtiger_List_Js.triggerSendSms("index.php?module=Invoice&view=MassActionAjax&mode=showMandoubStausForm","Invoice");'>تعديل حالة المندوب</a></li>
                            {/if}
                            ...
                            {/if}
                            {if $FIND_DUPLICATES_EXISTS AND $CURRENT_USER_MODEL->isAdminUser() }
