...
<div id="sendSmsContainer" class='modal-xs modal-dialog'>
    <div class = "modal-content">
        {assign var=TITLE value="تعديل حالة المندوب"}
        ...
        <form class="form-horizontal" id="massSave" method="post" action="index.php">
            ...
            <input type="hidden" name="action" value="MassMandoubStaus" />
            ...
            <div class="modal-body">
                <div>
                    <span><strong>حدد حالة المندوب</strong></span>
                </div>
                <br>
                <div>
                    <div>
                        <select name="fields" data-placeholder="حدد حالة المندوب" data-rule-required="true"  class = "select2 form-control" required>
                              <option value="">حدد حالة </option>

                                <option value="delivered and paid">مسلم مدفوع</option>
                                <option value="delivered and not paid">مسلم وغيرمدفوع</option>
                                <option value="not delivered">غير مسلم</option>
                                <option value="balance">خالص الاجرة</option>
