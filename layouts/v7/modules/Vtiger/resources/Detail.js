...
Vtiger.Class("Vtiger_Detail_Js",{
	...
	*/
	...
	registerAjaxEditEvent : function(){
		var thisInstance = this;
		var detailContentsHolder = this.getContentHolder();
		//haithem3  detailContentsHolder.on('click','table.detailview-table td.fieldValue .editAction', function(e) {
	...
	registerSummaryViewContainerEvents : function(summaryViewContainer){
		...
		this.loadWidgets();
		/**
		 * Function to handle the ajax edit for summary view fields haithem
		 summaryViewContainer.on('mouseover','table.summary-table td.fieldValue .editAction', function(e){
		 */
	...
	registerHeaderAjaxEditEvents : function(contentHolder) {
        ...
        //haithem2 ,'.recordBasicInfo .fieldLabel .editAction', function(e){
