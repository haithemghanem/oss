					...
					<div>
						...
						<div class="row">
							...
							<div class="col-lg-6 pull-left" >
								<div class="row">
									<span class="col-lg-6 pull-left">{$TASK_PROGRESS_HEADER} :</span>
											...
											<div class="dropdown pull-left">
												...
												<ul class="dropdown-menu widgetsList" data-recordid="{$RELATED_RECORD->getId()}" data-fieldname="projecttaskprogress" 
													...
													{foreach item=PICKLIST_VALUE key=PICKLIST_NAME from=$PICKLIST_VALUES}
														<li class="editTaskDetails"><a>
														<div class="progress">
                                                           <div class="progress-bar progress-bar-striped" role="progressbar" style="width:{$PICKLIST_VALUE}" aria-valuenow="{$PICKLIST_VALUE}" aria-valuemin="0" aria-valuemax="100"></div></div>
							...
							<div class="col-lg-6 pull-left">
								<div class="row">
									<span class="col-lg-6 pull-left">{$TASK_STATUS_HEADER} :</span>
									{if $PERMISSIONS && $FIELD_MODEL->isEditable()}
