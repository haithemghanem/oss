	...
	<div class="col-lg-12">
		...
		<div class="col-lg-5">
			<div class="marketingDiv widgetHeight">
				...
				{else}
					<div class="inActiveImgDiv">
						<div>
							<h4>مرحباً بكم الى نظام الأسطورة مباشر للنقل </h4>
						</div>
						<a href="https://solutions-time.com" target="_blank" style="margin-right: 25px;"><img src="layouts/v7/resources/Images/AL-OSTORAH.PNG" style="width: 85%; height: 100%; margin-top: 25px;"/></a>
					</div>
				{/if}
				</div>
			</div>
			...
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/AL-OSTORAH.PNG">
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<input style="text-align:right" id="username" type="text" name="username" placeholder="اسم المستخدم">
							<span class="bar"></span>
							<label>Username</label>
						</div>
						<div class="group">
							<input  style="text-align:right" id="password" type="password" name="password" placeholder="كلمة السر">
							<span class="bar"></span>
							<label>password</label>
						</div>
						<div class="group">
							<button type="submit" class="button buttonBlue">دخـــول</button><br>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue forgot-submit-btn">ارسال</button><br>
			...
			jQuery(document).ready(function () {
				...
				loginFormDiv.find('button').on('click', function () {
					...
					if (username === '') {
						...
						errorMessage = 'كلمة السر غير صحيح';
						result = false;
					}
					if (errorMessage) {
