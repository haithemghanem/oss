			...
			if ($uitype == 4 && $insertion_mode != 'edit') {
				...
				if (!CRMEntity::isBulkSaveMode()){
				    ...
				    if($module == 'Invoice'){
                    	...
                    	if("Riyadh" == $this->column_fields['cf_950'] ){ //chaing cf_948 to cf_950
                            $fldvalue ="R-";
                    	}elseif("Mahail Asir"  == $this->column_fields['cf_950']){
                    		 $fldvalue ="M-";
                    	}elseif("Khamis Mushait" == $this->column_fields['cf_950'] ){
                             $fldvalue ="K-";
                    	}elseif("Abha"  == $this->column_fields['cf_950'] ){
                             $fldvalue ="A-";
                    	}elseif( "Jeddah"  == $this->column_fields['cf_950'] ){
                             $fldvalue ="J-";
                    	}elseif("Dammam"  == $this->column_fields['cf_950'] ){
                              $fldvalue ="D-";
                    	}elseif("Dawasir Valley"  == $this->column_fields['cf_950'] ){
                              $fldvalue ="V-";
                    	}elseif("jawal alttayir Jeddah"  == $this->column_fields['cf_950'] ){
                              $fldvalue ="JJ-";
                    	}elseif("jawal alttayir KM"  == $this->column_fields['cf_950'] ){
                              $fldvalue ="JK-";
                    	}else{
                             $fldvalue ="AS-"; 
                    	}
                    	$invv = $adb->getUniqueID("inv"); //$this->setModuleSeqNumber("increment", $module);
                    	$fldvalue .=$invv;
